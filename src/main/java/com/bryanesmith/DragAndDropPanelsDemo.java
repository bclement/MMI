// Downloaded on 6/19/11 from
// http://www.bryanesmith.com/documents/drag-and-drop-panel-demo/index.html

package com.bryanesmith;
        ...
        if (dragAndDropPanelDataFlavor == null) {
			dragAndDropPanelDataFlavor = new DataFlavor(
					DataFlavor.javaJVMLocalObjectMimeType
							+ ";class=com.bryanesmith.RandomDragAndDropPanel");
        }
